...
// Consulta SQL base para mostrar documentos del usuario
$sql = "SELECT id, nombre_archivo, ruta_archivo, titulo, estado, tipo_documento FROM documentos WHERE usuario_id = '$usuario_id' and documento_estado = 1";
...
<div class="container">
    ...
    <br>
    <br>
    <form action="ver_documentos.php" method="GET">
    ...
    <table>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                            ...
                            <td><span class='confirmar-eliminar' onclick='confirmarEliminar({$row['id']});'><i class='far fa-trash-alt'></i></span></td>
                            ...
                            <td><button class='btn-editar' onclick='editarDocumento({$row['id']});'>Editar</button></td>
                        </tr>";
        }
        ?>
        </tbody>
