...
<body>
            ...
            <?php if($correcto){ ?>
                <form action="cambiarpassword.php" method="POST" onsubmit="return validarContraseñas(event)">
                    <h1>-Restablecer contraseña-</h1>
                        ...
                        <button type="button" class="btn btn-primary" id="submitButton" onclick="redirigir()">Cambiar</button>
                </form>
            <?php } else { ?>
    ...
    <script>
    function redirigir() {
        // Puedes cambiar "otra_pagina.php" por la URL de la página PHP a la que deseas redirigir
